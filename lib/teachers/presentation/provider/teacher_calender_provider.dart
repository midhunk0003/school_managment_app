...
import 'package:schoolmanagment/teachers/data/teacher_calender_event_model.dart';

class TeacherCalenderProvider extends ChangeNotifier {
  DateTime selectedDate = DateTime.now();
  bool isLoading = true;
  bool _eventLoading = false;

  bool get eventLoading => _eventLoading;
  List<TeacherCalenderEventModel> _events = [];

  List<TeacherCalenderEventModel> get _allEvents => _events;

  List<TeacherCalenderEventModel> get events =>
      _allEvents
  ...
  void addEvent(TeacherCalenderEventModel event) {
    _events.add(event);
    notifyListeners();
  }
