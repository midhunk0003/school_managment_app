...
class TMessageScreen extends StatefulWidget {
  const TMessageScreen({Key? key}) : super(key: key);

  @override
  State<TMessageScreen> createState() => _TMessageScreenState();
}

class _TMessageScreenState extends State<TMessageScreen>
                ...
                children: [
                  ...
                  Container(
                    child: TabBar(
                      ...
                      tabs: [Tab(text: "Parent"), Tab(text: "Admin")],
                    ),
                  ),
                  SizedBox(height: isTablet ? 40 : 20),
                  ...
                  Expanded(
                    child: TabBarView(
                      controller: _tabController,
                      children: [TParentMessageScreen(), TAdminMessageScreen()],
                    ),
                  ),
                ],
              ),
