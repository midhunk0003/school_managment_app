...
class GalleryEditAlbumScreen extends StatefulWidget {
  const GalleryEditAlbumScreen({Key? key}) : super(key: key);

  @override
  _GalleryEditAlbumScreenState createState() => _GalleryEditAlbumScreenState();
}

class _GalleryEditAlbumScreenState extends State<GalleryEditAlbumScreen> {
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    HeaderandBackwidget(text: 'Edit Album'),
