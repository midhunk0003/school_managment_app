...
class TeachersMessageScreen extends StatefulWidget {
  const TeachersMessageScreen({Key? key}) : super(key: key);

  @override
  _TeachersMessageScreenState createState() => _TeachersMessageScreenState();
}

class _TeachersMessageScreenState extends State<TeachersMessageScreen> {
                      ...
                      trailing: Column(
                        children: [
                          ...
                          message['incommingMessage']
                              ...
                              : message['isRead']
                              ? Icon(Icons.done_all, color: Color(0xFFEE742A))
                              : Icon(Icons.check),
                        ],
                      ),
                    );
